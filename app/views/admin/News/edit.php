						...
						<div class="panel-body no-padding">
                            <form action="<?=ADMIN;?>/news/edit" method="post" data-toggle="validator">
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <input type="text" name="title" class="form-control" placeholder="Sarlavha matni" value="<?=h($news->title); ?>" id="title" required>
                                    <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                </div>

                                <div class="form-group has-feedback">
                                    <label for="description">Habar matni</label>
                                    <textarea name="description" id="editor1" cols="80" rows="10" required><?= $news->description; ?></textarea>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <div class="box-body"><br>
                                            ...
                                            <div class="photo">
                                            <img src="/images/<?=$news->img;?>" alt="" style="max-height: 170px; margin-left: 5px;">
                                            </div><br>
                                        </div>
                                            <div class="overlay">
